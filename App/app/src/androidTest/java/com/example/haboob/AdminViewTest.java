...
public class AdminViewTest {
    ...
    /**
     * Tests the complete navigation flow through all admin fragments.
     *
     * <p>This integration test verifies the entire navigation flow:</p>
     * <ol>
     *   <li>Start at AdminMainFragment</li>
     *   <li>Navigate to AdminPosterFragment</li>
     *   <li>Navigate back to AdminMainFragment</li>
     *   <li>Navigate to ProfileFragment</li>
     * </ol>
     *
     * <p>This ensures that the navigation stack works correctly throughout the entire flow.</p>
     */
    @Test
    public void testCompleteAdminNavigationFlow() {
        // Start at AdminMainFragment
        FragmentScenario<AdminMainFragment> scenario = FragmentScenario.launchInContainer(
                AdminMainFragment.class,
                null,
                R.style.Theme_Haboob
        ...
        // Step 1: Verify we're on AdminMainFragment
        onView(withId(R.id.admin_view_posters_button))
                .check(matches(isDisplayed()));

        // Step 2: Navigate to AdminPosterFragment
        onView(withId(R.id.admin_view_posters_button))
                .perform(click());
        ...
        // Step 3: Navigate back to AdminMainFragment
        onView(withId(R.id.action_goBack))
                .perform(click());
        ...
        // Step 4: Navigate to ProfileFragment
        onView(withId(R.id.btn_admin_back))
                .perform(click());
